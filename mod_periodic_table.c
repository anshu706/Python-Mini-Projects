...
const Element *find_element_by_atomic_number(int atomic_number)
{
    int i;
...
int main()
{
    ...
    printf("Total elements available: %d\n\n", element_count);
    ...
    while (1)
    {
        ...
        if (choice == 2)
        {
            printf("Closing periodic table. Goodbye.\n");
            break;
        }
        ...
        if (element == NULL)
        {
            printf("No element found for atomic number %d.\n\n", atomic_number);
            continue;
        }
